 ...
 */
class TextureRenderer(private val isExternalEOS: Boolean = true) {
    ...
    val texId: Int get() = textureHandles[0]
    ...
    fun draw(mvpMatrix: FloatArray, texMatrix: FloatArray?, bitmap: Bitmap?) {
